...
import { addItem, toggleCartPending } from '../../Store/cartSlice';
...
function Products() {
  ...
  const addCartLoading = useSelector(state => state.cart.cartPending);
  ...
  const addProduct = (product, key) => {
    ...
    dispatch(toggleCartPending(true));
  ...
  return (
    <>
      <Typography variant="h3" component='h1' textAlign='center' sx={{marginTop: '2.5em', marginBottom: '2em'}}>
            ...
            <Grid key={idx} item >
              <Card sx={{width: "300px"}}>
                <CardContent>
                  ...
                  <Typography variant="body2" sx={{minHeight: '30px'}}>
                    {product.description}
                  </Typography>
